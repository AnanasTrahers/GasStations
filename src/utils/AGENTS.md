...
Cross-cutting helpers used by the API, service layer, clients, scrapers, and DAGs: structured logging, request-scoped IDs, Redis cache, ETag, WKT geometry builders, response shape extractors, and datetime/uuid factories.
